...
def analysis_txt():
    ...
    rx = np.load(fr"D:\Pycharm\SEU-CAM-25-Newton-s-Apple\Channel Measurement\record\LDPC\received_signal_chirp_l2_10_24k_fs48k_N4096_cp1024_S8diff_R1-2_Z27_802.11n_A_scrambler7b_3.npy")
    pilot = np.load(fr"D:\Pycharm\PythonProject1\save\pilot_different_txt812(1).npy")
