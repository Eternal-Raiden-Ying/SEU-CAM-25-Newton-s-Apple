...
def analysis_txt(plot=False, plot_opt=None):
    rx = np.load(
        fr"D:\Documents\Coding\Python\SEUCAM\Channel Measurement\temp\received_tiff_chirp_l2_10_24k_fs48k_N8192_cp1024_S8diff_R1-2_Z27_802.11n_A_random_middle_0.8_1.npy")
    pilot = np.load(
